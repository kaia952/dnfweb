...
//---------------管理用户------------------------
    app.get("/admin/userManage/:page",user.checkUserState,user.checkUserPermission,user.userManage);
    app.get("/admin/userManage",user.checkUserState,user.checkUserPermission,user.userManage);
    app.get("/admin/deleteUser",user.checkUserState,user.checkUserPermission,user.deleteUser);
    app.get("/admin/changePermission",user.checkUserState,user.checkUserPermission,user.changePermission);
    app.post("/admin/modifyUserPermission",user.checkUserState,user.checkUserPermission,urlencodedParser,user.modifyPermissionHandler)
};
